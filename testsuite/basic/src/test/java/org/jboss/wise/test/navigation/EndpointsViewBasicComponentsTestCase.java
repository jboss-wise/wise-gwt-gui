 ...
 */
@RunWith(Arquillian.class) public class EndpointsViewBasicComponentsTestCase extends WiseTest {
    ...
    @Test public void stepOneOfThreeTest() {
    ...
    private void comfirmNavigationComponents() {
        ...
        try {
            ...
            List<WebElement> buttonList = browser.findElements(By.className(PropUtils.get("tag.wise-gwt-Button")));
            Assert.assertTrue("Endpoint button list should have 2 entries but found : " + buttonList.size(),
                    (2 == buttonList.size()));
    ...
    private void comfirmData() {
        ...
        try {
            ...
            Assert.assertTrue("Endpoint list should have 13 entries but found : " + treeItemsList.size(),
