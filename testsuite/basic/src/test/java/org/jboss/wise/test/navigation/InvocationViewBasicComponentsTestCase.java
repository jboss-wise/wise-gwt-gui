 ...
 */
@RunWith(Arquillian.class) public class InvocationViewBasicComponentsTestCase extends WiseTest {
     ...
     */
    @Test public void stepThreeOfThreeTest() {
    ...
    private void comfirmUIComponents() {
        ...
        try {
            ...
            Assert.assertTrue("1 disclosure Panels expected but " + disclosurePanelList.size() + " panels found.",
