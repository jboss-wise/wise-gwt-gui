 ...
 */
@RunWith(Arquillian.class) public class RefreshPreviewMsgTestCase extends WiseTest {
    ...
    private void checkStepTwoData(List<String> inputList) {
        ...
        try {
            ...
            WebElement refreshButton = browser.findElement(By.className(PropUtils.get("tag.wise-gwt-button-refresh")));
