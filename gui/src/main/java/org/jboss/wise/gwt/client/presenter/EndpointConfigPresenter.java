...
public class EndpointConfigPresenter implements Presenter {
    ...
    public void bind() {
        ...
        processingExceptionEventRegistration = eventBus
                .addHandler(ProcessingExceptionEvent.TYPE, new ProcessingExceptionEventHandler() {
                    @Override public void onProcessingException(ProcessingExceptionEvent event) {
        ...
        loginRequestEventRegistration = eventBus.addHandler(LoginRequestEvent.TYPE, new LoginRequestEventHandler() {
        ...
        loginEventRegistration = eventBus.addHandler(LoginEvent.TYPE, new LoginEventHandler() {
        ...
        loginCancelEventRegistration = eventBus.addHandler(LoginCancelEvent.TYPE, new LoginCancelEventHandler() {
            @Override public void onLoginCancel(LoginCancelEvent event) {
        ...
        closeHandlerRegistration = this.display.getPreviewDisclosurePanel()
    ...
    private void doLogin() {
        CredentialDialogBox cDialogBox = new CredentialDialogBox(rpcService, eventBus, this.wsdlInfo.getUser(),
                EndpointConfigPresenter.this.display.getParamsConfig());
